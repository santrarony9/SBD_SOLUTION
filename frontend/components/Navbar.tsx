                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden md:flex space-x-6 items-center">
                        ...
                        <div className="flex items-center space-x-4 ml-4 border-l border-gray-600 pl-6">
                            ...
                            <button className={`${textColor} hover:text-brand-gold transition-colors relative ml-2`}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {isAuthenticated ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="block w-full text-center px-3 py-3 text-white hover:text-brand-gold hover:bg-white/5 text-sm tracking-widest uppercase transition-colors"
                                >
                                    Logout
                                </button>
                            </>
